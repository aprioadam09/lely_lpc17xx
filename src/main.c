...
static co_unsigned32_t on_dn_2000_01(co_sub_t *sub, struct co_sdo_req *req,
		void *data);
static co_unsigned32_t on_up_2001_01(const co_sub_t *sub,
...
main(void)
{
	...
	// 2000:01.
	co_sub_set_dn_ind(co_dev_find_sub(dev, 0x2000, 0x01), &on_dn_2000_01,
			NULL);

	// Set the upload (SDO read) indication function for sub-object 2001:01.
	co_sub_set_up_ind(co_dev_find_sub(dev, 0x2001, 0x01), &on_up_2001_01,
			NULL);
...
on_dn_2000_01(co_sub_t *sub, struct co_sdo_req *req, void *data)
{
	assert(sub);
...
static co_unsigned32_t
on_up_2001_01(const co_sub_t *sub, struct co_sdo_req *req, void *data)
{
